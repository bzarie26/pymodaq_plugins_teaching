...
class DAQ_Move_Monochromateur(DAQ_Move_base):
    ...
    def ini_attributes(self):
        #  TODO declare the type of the wrapper (and assign it to self.controller) you're going to use for easy OK
        #  autocompletion
    ...
    def ini_stage(self, controller=None):
        ...
        info = "ça y est c'est mardi, c'est bientot le week-end"
    ...
    def move_abs(self, value: DataActuator):
        ...
        self.controller.set_wavelength(value.value(),'abs')  # when writing your own plugin replace this line
